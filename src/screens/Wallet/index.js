      ...
      <div id="page-container">
        ...
        <main id="main-container">
          ...
          <div className="row_view">
            ...
            <p className="text_center desktop_none">We fund a 10% donation on top of your<br></br>
                  monthly token earnings to a charitable cause,<br></br>
                  and 10% to a charity, as voted by you.
            </p>
            <div className="coin_div">
              <p>Eco Coins</p>
